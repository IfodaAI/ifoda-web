...
class GetStatement:
    ...
    def __call__(self, params: dict):
        clean_data: dict = PaymeTransactionSerializer.get_validated_data(params=params)
        ...
        try:
            transactions = PaymeMerchantTransaction.objects.filter(
            ...
            statements = [
                {
                    ...
                    'state': t.state,
                    'reason': int(t.reason) if t.reason else None,
